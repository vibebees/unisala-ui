      ...
      <div className="relative bg-white dark:bg-gray-900">
        <div className="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
          <div className="flex items-center justify-between">
            <a href="/">
              <Image className="w-auto h-6 sm:h-7" src="https://merakiui.com/images/full-logo.svg" alt="Meraki UI Logo" width={100} height={100}/>
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="container px-6 py-16 mx-auto">
        <div className="items-center lg:flex">
          ...
          <div className="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
            <Image className="w-full h-full lg:max-w-3xl" src="https://merakiui.com/images/components/Catalogue-pana.svg" alt="Catalogue Display" width={100} height={100}/>
          </div>
        </div>
      </div>
    </div>

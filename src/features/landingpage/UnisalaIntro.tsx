  ...
  const articleContentFirst = [
    {
      ...
      description:
        "Find Your University Fit with Unisala 🎓🔍 Choose from your programs, Search by major, and filter by fees or state. Simple, quick, and tailored to you. Discover the place where you'll flourish both academically and personally!",
    },
  ];
  ...
  const articleContentLast = [
    {
      ...
      title:
        "Bring your projects to life with a community that shares your vision",
      description:
        "Share your ideas, articles, or projects on Unisala.com 📝💡 and find like-minded peers or teammates 👥. Collaborate, inspire, and grow together in a community that turns collective aspirations into reality 🚀🌐.",
    },
  ];

      ...
      <div className="mx-auto max-w-screen-lg px-4 2xl:px-0">
        <div className="flex flex-col items-center mb-8">
          ...
          <form className="w-full max-w-2xl">
            <label htmlFor="large-search" className="sr-only">Search</label>
            <div className="relative">
              ...
              <input
                type="search"
                id="large-search"
                className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-4 ps-12 text-base text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"

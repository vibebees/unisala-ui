    ...
    <AuthProvider>
      <div className=" dark: text-black dark:text-white relative min-h-screen ">
        ...
        <div className="flex h-[calc(100vh-64px)]">
          ...
          <div
            className={`fixed right-0 top-0 w-[400px] h-[calc(100vh-64px)]  shadow-lg border-l border-gray-200 transform transition-transform duration-300 ${showImagePanel ? 'translate-x-0' : 'translate-x-full'
              }`}
          >

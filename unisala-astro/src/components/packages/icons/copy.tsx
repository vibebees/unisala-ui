export const CopyIconOutline = () => (
    <svg className="w-[30px] h-[30px] text-grey-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
export const CopyIconFilled = () => (
    <svg className="w-[30px] h-[30px] text-grey-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
